...
export const FULL_I18N: Record<"en" | "ja", Record<string, string>> = {
	en: {
		...
		朗读日语: "Speak Japanese",
		停止: "Stop",
		"点选下方常用沟通卡，或输入文字，系统会翻译成对方的语言展示给对方。":
			"Tap a common phrase below, or type your own words — they will be translated into the other person's language.",
		常用沟通卡: "Common phrases",
		"输入想说的话…": "Type what you want to say…",
		发送: "Send",
		源语言: "From",
		目标语言: "To",
		交换语言: "Swap languages",
		...
		迷路: "Lost",
		身体不适: "Feeling unwell",
		"丢失财物 / 护照": "Lost belongings / passport",
		交通事故: "Traffic accident",
		中暑: "Heatstroke",
		被困电梯: "Stuck in an elevator",
		状态确认: "Status check",
		行动: "Action",
		下一步: "Next",
		现在应该做: "Do this now",
	...
	ja: {
		...
		停止: "停止",
		"点选下方常用沟通卡，或输入文字，系统会翻译成对方的语言展示给对方。":
			"下のよく使うフレーズを選ぶか、伝えたいことを入力してください。相手の言語に翻訳して表示します。",
		常用沟通卡: "よく使うフレーズ",
		"输入想说的话…": "伝えたいことを入力…",
		发送: "送信",
		源语言: "翻訳元",
